...
Platforma omogucava:
  ...
  - Objavljivanje i kupovina proizvoda, usluga (obrada zemljista, servisiranje masina, iznajmljivanje zemljista ako je to zelja, prodaja zemlje i masina)
  - Povezivanje sa lokalnim proizvodjacima i vlasnicima kompanija
  - Izvoz transakcija i porudzbina u Excel dokumentu pogodnom za stampanje

Web aplikacija se --trenutno-- razvija u MCV arhitekturi u OOP PHP-u, Boostrapu, JavaScriptu, i MySQL-u.
